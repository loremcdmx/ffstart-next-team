...
- The memory check grades the exact source code of all 169 cells for the selected size and position, including both 50/50 split types; an unpainted cell is treated as fold.
