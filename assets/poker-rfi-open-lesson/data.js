...
var positions={
 ...
 MP:{pct:0,label:"средняя",hint:"Добавляем offsuit-бродвеи и часть младших одномастных королей; половинные клетки источника остаются за границей."},
 ...
 BTN:{pct:0,label:"баттон",hint:"Два блайнда за спиной: весь suited-верх и большинство offsuit-рук с исходным весом выше 75%."}
};
...
var firstSpot={
 ...
 options:[
  ...
  {key:"limp",label:"Колл",correct:false,feedback:"В базовой стратегии unopened-банка лимпа нет. За спиной шесть игроков, поэтому A9o здесь пас."},
